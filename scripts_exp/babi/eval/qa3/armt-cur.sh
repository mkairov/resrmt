...
for N in lr4_paper_run_cur1 lr4_paper_run_cur2; do
...
MODEL_PATH="/home/admin/rmt/runs/${TASK_DATASET}/${MODEL_NAME}/${MODEL_KIND}/eval/lr${LR}_${SCHEDULER}_${OPTIMIZER}_wd${WEIGHT_DECAY}_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_resmem${RES_MEM_COUNT}_bs${TBS}_bptt-${K2}_from_cpt_${SRC_N_SEGMENTS}-${MAX_N_SEGMENTS}/run_${N}"
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29041 run_finetuning_babilong_resrmt.py \
