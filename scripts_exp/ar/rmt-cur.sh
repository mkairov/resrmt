...
VALUE_SIZES=(1 1 1 1 1)
BSS=(128 128 128 128 128)
ITERSS=(2000 10000 10000 10000 10000)

DIM=128
NUM_LAYERS=4

# for N in ar_final_cur1 ar_final_cur2 ar_final_cur3; do
for N in ar_final_cur3; do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29232 run_finetuning_associative_retrieval.py \
        --task_name $TASK_NAME \
