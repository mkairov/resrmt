...
NUMS_PAIRSS=(4 0 8 0 16)
KEY_SIZES=(2 0 2 0 2)
VALUE_SIZES=(2 0 2 0 2)
BSS=(128 0 128 0 128)
ITERSS=(200000 0 200000 0 200000)
...
BLOCK_SIZE=$((2 * KEY_SIZE + 2 * VALUE_SIZE + 4))
...
accelerate launch --config_file $ACCEL_CONFIG run_finetuning_associative_retrieval.py \
        --task_name $TASK_NAME \
        ...
        --init_inner_lr 1.0 --inner_steps 3 --inner_clip_norm 1.0 \
        --save_best --use_write_head
